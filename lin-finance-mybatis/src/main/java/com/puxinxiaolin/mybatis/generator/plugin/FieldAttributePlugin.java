package com.puxinxiaolin.mybatis.generator.plugin;
...
public class FieldAttributePlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        String queryVoSuffix = properties.getProperty("QUERVO_VO_SUFFIX", "Field");
        TopLevelClass root = new TopLevelClass(join(model, queryVoName + queryVoSuffix));
//        root.addImportedType(model + "." + queryVoName);
        root.setVisibility(JavaVisibility.PUBLIC);
        root.addImportedType("com.puxinxiaolin.mybatis.help.DbField");
        root.addImportedType("com.puxinxiaolin.mybatis.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.puxinxiaolin.mybatis.help.FieldResult"));
